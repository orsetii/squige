...
pub struct Section {
    ...
    pub pointer_to_relocations: Addr32,
...
impl Section {
    ...
    /// Range where the segment would be in virtual memory.
    #[allow(dead_code)]
    pub fn mem_range(&self) -> Range<Addr32> {
        self.virtual_address..(self.virtual_address + Addr32::from(self.virtual_size))
    }
